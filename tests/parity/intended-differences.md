...
32. **Bez newsów**: decyzja właściciela z 17.09.2026. W oryginale druga karta panelu to „News”, u nas „Powiązania”; pasek „Who's in the news” zastępuje karta „Mapa władzy” (patrz 36).
...
36. **Mapa władzy liczy się z relacji ustawowych, nie z newsów** (decyzja właściciela z 18.09.2026). Układ jak w oryginale: lider u góry, dwadzieścia kafli z okrągłymi zdjęciami i liniami powołań, przełącznik w prawym dolnym rogu, adres `#view=power`. Zamiast liczby artykułów kafel pokazuje sumy relacji („powołuje 235 · wnioskuje o 24”), a zamiast „In the news 21h ago” nie ma nic. Wzór zasięgu jest wypisany na scenie. Kafle stoją w równych rzędach z lekkim przesunięciem, nie w swobodnym rozrzucie oryginału, żeby dwadzieścia kafli mieściło się bez nakładania na scenie o szerokości 40–60% okna.
